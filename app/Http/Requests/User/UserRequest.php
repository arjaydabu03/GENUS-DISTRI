...
class UserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "order_type.id" => Rule::requiredIf($this->input("role_id") == 2),
            "order_type.code" => Rule::requiredIf($this->input("role_id") == 2),
            "order_type.desc" => Rule::requiredIf($this->input("role_id") == 2),
